// https://www.gingerbill.org/code/memory-allocation-strategies/part002.cs
...
void *arena_alloc_align(Arena *a, size_t size, size_t align) {
    ...
    printf("=========================================================\n");
    printf("uintptr_t offset = align_forward(curr_ptr, align);\n");
    printf("offset = %zu\n", offset);

    printf("=========================================================\n");
    printf("offset -= (uintptr_t)a->buf; // Change to relative offset\n");
    printf("a->buf\n");
    printf("%zu\n", (uintptr_t)a->buf);
